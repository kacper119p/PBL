...
void main()
{
    ...
    velocity = vec3(0.0, 1.0, 0.0); // default up
    ...
    vec3 billboardOffset = ((inputTexCoord.x - 0.5) * billboardRight + (inputTexCoord.y - 0.5) * billboardUp) * particleData.scale;
