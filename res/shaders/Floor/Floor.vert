...
uniform mat4 BloodMaskViewProjection;
...
void main()
{
    ...
    vec4 BloodSpacePosition = BloodMaskViewProjection * ObjectToWorldMatrix * vec4(inputPosition, 1.0);
    BloodSpacePosition.xyz /= BloodSpacePosition.w;
    BloodMaskCoords = BloodSpacePosition.xy * 0.5 + 0.5;
}
