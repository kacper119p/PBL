...
namespace Models
{
    ...
    public:
         ...
         * @return Loaded model.
         */
        [[nodiscard]] static Model* GetModel(const char* Path);

        [[nodiscard]] static ModelAnimated* GetAnimatedModel(const char* Path);

        [[nodiscard]] static Animation* GetAnimation(const char* Path);
         ...
         * @return True if model is loaded, false otherwise.
         */
        [[nodiscard]] static bool IsValid(const Model* Model);

        [[nodiscard]] static bool IsValid(const ModelAnimated* Model);

        [[nodiscard]] static bool IsValid(const Animation* Animation);
         ...
         */
        [[nodiscard]] static std::string GetModelPath(const Model* Model);

        [[nodiscard]] static std::string GetAnimatedModelPath(const ModelAnimated* Model);

        [[nodiscard]] static std::string GetAnimationPath(const Animation* Animation);
    };
