...
void Engine::MopEmitter::Render(const Engine::CameraRenderData& RenderData)
{
...
void Engine::MopEmitter::DispatchSpawnShaders(const float DeltaTime)
{
    Timer += DeltaTime;
...
void Engine::MopEmitter::DispatchUpdateShaders(const float DeltaTime)
{
    UpdateShader.Use();
...
#if EDITOR
void Engine::MopEmitter::DrawImGui()
{
...
#endif
rapidjson::Value Engine::MopEmitter::Serialize(rapidjson::Document::AllocatorType& Allocator) const
{
    START_COMPONENT_SERIALIZATION
    END_COMPONENT_SERIALIZATION
}

void Engine::MopEmitter::DeserializeValuePass(const rapidjson::Value& Object,
...
void Engine::MopEmitter::DeserializeReferencesPass(const rapidjson::Value& Object,
                                                            Serialization::ReferenceTable& ReferenceMap)
{
