...
Engine::ExhaustVFX::ExhaustVFX() :
    ParticleEmitter(Materials::MaterialManager::GetMaterial("res/materials/VFX/ExhaustVFX.mat"),
                    Shaders::ShaderManager::GetComputeShader("res/shaders/VFX/Exhaust/ExhaustSpawn.comp"),
                    Shaders::ShaderManager::GetComputeShader("res/shaders/VFX/Exhaust/ExhaustUpdate.comp")),
...
void Engine::ExhaustVFX::Render(const Engine::CameraRenderData& RenderData)
{
...
void Engine::ExhaustVFX::DispatchSpawnShaders(const float DeltaTime)
{
    Timer += DeltaTime;
...
void Engine::ExhaustVFX::DispatchUpdateShaders(const float DeltaTime)
{
    UpdateShader.Use();
...
#if EDITOR
void Engine::ExhaustVFX::DrawImGui()
{
    if (ImGui::CollapsingHeader("Exhaust VFX"))
    {
    }
}
#endif
rapidjson::Value Engine::ExhaustVFX::Serialize(rapidjson::Document::AllocatorType& Allocator) const
{
    START_COMPONENT_SERIALIZATION
    END_COMPONENT_SERIALIZATION
}

void Engine::ExhaustVFX::DeserializeValuePass(const rapidjson::Value& Object,
...
void Engine::ExhaustVFX::DeserializeReferencesPass(const rapidjson::Value& Object,
                                                   Serialization::ReferenceTable& ReferenceMap)
{
