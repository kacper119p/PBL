...
namespace Scene
{
    ...
    void SceneBuilder::Build(Engine::Scene*& Scene)
    {
        ...
        secondBoxModelRenderer->SetMaterial(Materials::MaterialManager::GetMaterial("./res/materials/SampleScene/Box.mat"));
        ...
        secondBoxModelRenderer2->GetMaterial()
                ->GetMainPass().SetUniform("Tint", glm::vec3(0.0f, 25.0f, 0.0f));
