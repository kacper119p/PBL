...
namespace Scene
{
    ...
    SceneBuilder::Build(Engine::Scene*& Scene)
    {
        ...
        goto Load;
        {
            ...
            Scene->SetSkybox(environmentMap);
            ...
            Engine::ModelRenderer* wallMonitorRenderer = new Engine::ModelRenderer(
                    wallMonitorMaterial, wallMonitorModel);
            ...
            Engine::ModelRenderer* ceilingLampRenderer = new Engine::ModelRenderer(
                    ceilingLampMaterial, ceilingLampModel);
